...
local decoding = require("cassandra.cassandra.decoding")
...
function _M.send_frame_and_get_response(self, op_code, body, tracing)
  ...
  return self.__sock:request(frame, self.read_response)
end
